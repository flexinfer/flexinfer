...
def patch_moe_wna16_rocm_reference_fallback(vllm_root: pathlib.Path) -> bool:
    ...
    new_block = (
        ...
        "                # Caps cache at 16 entries (= top_k=8 * 2 for w13/w2), so this\n"
        "                # is the difference between a working set that survives across\n"
        "                # apply() calls and one that gets fully evicted every call.\n"
        "                try:\n"
