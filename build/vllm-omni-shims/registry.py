...
"""Attention backend registry — shim for AMD Navi vLLM ~0.14.0rc1.dev2.

Sourced from upstream vLLM v0.14.0 stable (vllm-project/vllm#31916).
The AMD Navi base image predates this restructure; vllm-omni 0.14.0
imports AttentionBackendEnum from here.
"""
