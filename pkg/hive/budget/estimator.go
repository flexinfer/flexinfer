...
// Hive v2 rollout. It composes historical squad outcomes (path-class median),
...
// CostEstimate is the read-only preview returned by /api/hive/cost-preview.
...
func fallbackMedian(p *hive.Policy) float64 {
	if p == nil {
...
func recursionOverheadUSD(p *hive.Policy, median float64) float64 {
	if p == nil {
		return 0
	}
...
func ensembleCapUSD(p *hive.Policy) float64 {
	if p == nil {
		return 0
	}
