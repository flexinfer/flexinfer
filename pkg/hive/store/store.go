// Package store is the canonical persistence layer for the Loom Hive.
//
// All hive state — backlog items, council runs, pipeline runs, stage and gate
...
// schema and exposes typed DAOs; nothing outside the hive package tree should
...
// buildDSN composes a modernc.org/sqlite DSN with the PRAGMAs every hive
// connection needs:
