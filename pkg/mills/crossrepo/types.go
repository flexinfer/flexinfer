// Package crossrepo is the Mills v2 cross-repo coordination layer. A single
...
// `platform/gitops/k3s/mills/repos.yaml`. The Loader watches that file,
...
//
// Required:
//   - apiVersion exactly "mills.loom.dev/v1"
