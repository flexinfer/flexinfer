// Package squads is the Mills v2 hierarchical-swarm tactical layer. A squad
...
// `platform/gitops/k3s/mills/squads/*.yaml`. The Loader watches that
...
//
// See `.loom/93-product-spec-mills-v2-hierarchical-swarm-2026-05-02.md`
...
const APIVersion = "mills.loom.dev/v1"
...
type ManifestSpec struct {
	...
	// runs (Mills v2 bounded recursion). Default false.
