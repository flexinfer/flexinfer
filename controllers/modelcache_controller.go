...
const (
	...
	annotationValidateSpecHash     = "flexinfer.ai/validate-spec-hash"
	annotationRevalidate           = "flexinfer.ai/revalidate"
	annotationRevalidateHandled    = "flexinfer.ai/revalidate-handled"
