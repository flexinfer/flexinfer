...
- `docs/user/model-experiments.md` for isolated canary Models with durable gauntlet verdicts.
...
- **Experiments**: `ai.flexinfer/v1alpha2` `ModelExperiment` (bounded candidate + gauntlet lifecycle).
...
- `docs/user/gptq-quantization-runbook.md` - GPTQ recovery, timeout, and Qwen3.5 corrupted-source procedures
