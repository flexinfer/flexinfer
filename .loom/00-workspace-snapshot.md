...
gitlab-vm	https://oauth2:<redacted>@gitlab.flexinfer.ai/services/loom-core.git (fetch)
gitlab-vm	https://oauth2:<redacted>@gitlab.flexinfer.ai/services/loom-core.git (push)
origin	https://oauth2:<redacted>@gitlab.flexinfer.ai/services/loom-core.git (fetch)
origin	https://oauth2:<redacted>@gitlab.flexinfer.ai/services/loom-core.git (push)
```
