...
| `gfx906` persistent runtime hipMemGetInfo shim (2026-05-22) | n/a | `gfx906/radeonvii` | `runtime` | `experimental` | Pending publish of `registry.harbor.lan/flexinfer/runtime:rocm-gfx906-${CI_COMMIT_SHORT_SHA}` from `publish_runtime_rocm_gfx906`; digest TBD after CI | n/a | Source slice bakes `build/hipmemgetinfo_shim.cpp` and `build/patch-hipmemgetinfo.sh` into `build/Dockerfile.runtime-gfx906`, sets `LD_PRELOAD=/opt/flexinfer/lib/libflexinfer_hipmeminfo_shim.so`, and adds `deploy/debug/gfx906-llamacpp-proxy-soak.yaml` to persist proxy-soak JSONL and summary output to PVC `gfx906-llamacpp-proxy-soak-evidence`. | Existing persistent runtime `registry.harbor.lan/flexinfer/runtime@sha256:cbe1157c2fb6a24fc67e901bec92a72bbf16498a86ad1a064ce9bf4db1f2ddf4` does not carry the shim; the first proxy-backed attempt wedged during GPU-backed model load at `hipMemGetInfo`. | After CI publishes a digest: `scripts/promote-runtime-digest.sh gfx906 --digest sha256:<new> --validation-row "gfx906 persistent runtime hipMemGetInfo shim (2026-05-22)" --rollback-digest sha256:cbe1157c2fb6a24fc67e901bec92a72bbf16498a86ad1a064ce9bf4db1f2ddf4 --apply && kubectl apply -f deploy/debug/gfx906-llamacpp-proxy-soak.yaml` | `sha256:cbe1157c2fb6a24fc67e901bec92a72bbf16498a86ad1a064ce9bf4db1f2ddf4` | `.loom/ralph-gfx906-runtime-hipmem-shim-2026-05-22.md`; `build/Dockerfile.runtime-gfx906`; `deploy/debug/gfx906-llamacpp-proxy-soak.yaml` | `pending` |
