...
|---:|---|---|---|---:|---:|---:|---:|---:|
| 1 | DEBT-004 | Introduce unified local proxy session lease/epoch management | internal/daemon/session.go, cmd/loom/proxy.go, internal/daemon/http_handler.go | 0.80 | 1.00 | 0.80 | 4.0 | 80.00 |
...
| 5 | DEBT-009 | StdioTransport Recv context-cancel permanently closes transport | libs/mcp-go/transport.go | 0.40 | 0.40 | 1.00 | 4.0 | 52.00 |
