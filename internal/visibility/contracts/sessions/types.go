// Package sessions holds the agent-session DTOs surfaced through the
// agent_session_* tools and the HUD/CLI session surfaces.
//
// # Scaffold-only in S1
//
// The canonical SessionInfo type currently lives in internal/hud/bridge
...
// slice will move CanonicalProject and PipelineRef alongside SessionInfo
// and complete the lift.
//
// For now this package is reserved for that future placement and exists so
// downstream readers can import internal/visibility/contracts/sessions
// without churn when the lift completes.
package sessions
