...
// HubToolCaller implements orchestra.ToolCaller by sending tools/call requests
// to the MCP gateway over HTTP. This replaces the daemon-local bridge caller
// for the standalone binary, and is passed to orchestra.NewDaemonToolExecutor.
