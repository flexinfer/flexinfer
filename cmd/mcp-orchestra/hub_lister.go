...
// HubToolLister implements orchestra.ToolLister by calling the MCP gateway's
...
func (h *HubToolLister) ListTools() ([]orchestra.ToolInfo, error) {
	...
	tools := make([]orchestra.ToolInfo, len(result.Tools))
	for i, t := range result.Tools {
		tools[i] = orchestra.ToolInfo{
			Name:        t.Name,
