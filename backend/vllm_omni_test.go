...
func TestVLLMOmniBackendArgs_LimitMmPerPrompt(t *testing.T) {
	b := &VLLMOmniBackend{}
...
func TestVLLMOmniBackendArgs_MmProcessorKwargs(t *testing.T) {
	b := &VLLMOmniBackend{}
...
func TestVLLMOmniBackendArgs_MmArgsNotSetByDefault(t *testing.T) {
	b := &VLLMOmniBackend{}
